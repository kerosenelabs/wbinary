...
> Для обработки интерфейсов требуется больше затрат на память и производительность, соответственно лучше всего использовать пользовательские биндинги типов.
```csharp
